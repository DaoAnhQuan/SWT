...
def train(num_classes = 28, lr = 0.01, beta1 = 0.95, beta2 = 0.99, img_dim = 28, img_depth = 1, f = 5, num_filt1 = 10, num_filt2 = 10, batch_size = 16, num_epochs = 5, save_path = 'param.pkl'):

    # training data
    """m =50000
    X = extract_data('train-images-idx3-ubyte.gz', m, img_dim)
    y_dash = extract_labels('train-labels-idx1-ubyte.gz', m).reshape(m,1)"""
    X,y_dash = extract_data('C:\\Users\\daoan\\Desktop\\Python\\SWT\\Dataset',img_dim)
    X-= int(np.mean(X))
    X/= int(np.std(X))
    ...
    f1, f2, w3, w4 = (num_filt1 ,img_depth,f,f), (num_filt2 ,num_filt1,f,f), (128,num_filt2*100), (num_classes, 128)
